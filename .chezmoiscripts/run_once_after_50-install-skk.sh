...
mkdir -p $DICT_PATH
yaskkserv2_make_dictionary --utf8 --dictionary-filename="$DICT_PATH/$DICT_NAME" "$HOME/src/dict/SKK-JISYO.L.utf-8" "$HOME/src/my-skk-dict/SKK-JISYO.L.k2c.utf-8" "$HOME/src/dict/SKK-JISYO.fullname.utf-8" "$HOME/src/dict/SKK-JISYO.jinmei.utf-8" "$HOME/src/my-skk-dict/SKK-JISYO.sf6.utf-8" "$HOME/src/dict/SKK-JISYO.propernoun.utf-8" "$HOME/src/dict/SKK-JISYO.geo.utf-8" "$HOME/src/dict/SKK-JISYO.station.utf-8" "$HOME/src/dict/SKK-JISYO.JIS2.utf-8" "$HOME/src/dict/SKK-JISYO.assoc.utf-8" "$HOME/src/dict/SKK-JISYO.itaiji.utf-8" "$HOME/src/dict/zipcode/SKK-JISYO.zipcode.utf-8" "$HOME/src/dict/zipcode/SKK-JISYO.office.zipcode.utf-8" "$HOME/src/dict/SKK-JISYO.edict.utf-8" "$HOME/src/dict/SKK-JISYO.edict2.utf-8"
